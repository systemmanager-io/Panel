...
class Sidebar extends React.Component {
    ...
    render() {
        return (
            <div
                className="md:w-2/12 bg-gray-900 md:bg-gray-900 px-2 text-center md:h-screen md:border-r-4 md:border-gray-600">
                        ...
                        <li className="mr-3 flex-1">
                            <a href="ttesllst"
                               className="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-pink-500">
                                ...
                                className="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Linsssssssssssssssssssssssssk</span>
                            </a>
                        </li>
                        <li className="mr-3 flex-1">
                            <a href="test"
