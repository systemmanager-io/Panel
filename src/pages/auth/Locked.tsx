                ...
                <div className="max-w-md w-full">
                    ...
                    <div className={"mt-8"}>
                        ...
                        <div className="mt-6 flex">
                            <button type="submit"
                                    className="group relative flex-1 justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-l-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out">
                                Unlock
                            </button>
                            <button type="submit"
